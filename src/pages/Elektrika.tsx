      ...
      <div className="container pt-4">
        ...
        <section className="my-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { src: "https://cdn.poehali.dev/projects/00eabb41-cd43-402b-855a-9ee2fb26e229/bucket/9c1159a6-5b7e-46de-908c-90e6ebacac65.jpg", alt: "Монтаж электрощита в новостройке", label: "Электрощит", desc: "Новостройка, 4-комнатная квартира" },
              { src: "https://cdn.poehali.dev/projects/00eabb41-cd43-402b-855a-9ee2fb26e229/bucket/a29dc5ee-f14f-4c76-b4aa-7b28c47869ad.jpg", alt: "Электрощит в деревянном доме", label: "Щит учёта", desc: "Частный деревянный дом" },
              ...
              <div key={i} className="rounded-2xl overflow-hidden shadow-md group">
                ...
                <div className="p-4 bg-white dark:bg-gray-900">
                  <p className="font-semibold text-black dark:text-white text-sm">{photo.label}</p>
                  <p className="text-gray-500 dark:text-gray-400 text-xs mt-0.5">{photo.desc}</p>
                </div>
              </div>
            ))}
          </div>
